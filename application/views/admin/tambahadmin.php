...
<!-- DataTales Example -->
		...
		<?= form_open_multipart('c_admin_tambahadmin');?>
		 <div class="form-group row">
		    ...
		    <div class="col-sm-8">
		      <input type="number" class="form-control" id="nip" value="<?= set_value('nip'); ?>" required name="nip" autocomplete="off">
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-8">
		      <input type="text" class="form-control" id="nama_admin" value="<?= set_value('nama_admin'); ?>" required name="nama_admin" autocomplete="off">
		    </div>
		  </div>
		  ...
		  <div class="form-group row">
		    ...
		    <div class="col-sm-8">
		      <input type="text" class="form-control" id="jabatan" value="<?= set_value('jabatan'); ?>" required name="jabatan" autocomplete="off" >
		    </div>
		  </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" id="username" value="<?= set_value('username'); ?>" required name="username" autocomplete="off" >
